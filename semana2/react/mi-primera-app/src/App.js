  ...
  return (
    <div className="App">
      ...
      />
        ...
        "
      />
        <EventoB title="Py Café 02 - CV Review"
        image="evento2"
        dateLiteral="28 de Octubre de 2023 La Paz, Bolivia"
        placeLiteral="¡Hola Pythonista!

        ¿Conoces la importancia de tener un CV?"
        description="
        ¿Te gustaría obtener la opinión de un Senior sobre tu CV y como podrías mejorarlo?
